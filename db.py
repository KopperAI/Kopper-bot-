...
def create_sqlite_db():
    ...
    try:
        ...
        # Discord parameters
        cursor.execute("INSERT INTO parameters (key, value) VALUES (?, ?)", ("discord_enabled", "False"))
        cursor.execute("INSERT INTO parameters (key, value) VALUES (?, ?)", ("discord_token", ""))
        cursor.execute("INSERT INTO parameters (key, value) VALUES (?, ?)", ("discord_chat_id", ""))
        cursor.execute("INSERT INTO parameters (key, value) VALUES (?, ?)", ("discord_process_running", "False"))
